...
------------ | ------------- | -------------
0 | Denial | <ul><li>"Confirmation Bias": Data collection uses an unauthorized, passive and casual approach, such as conversations among selected and immediate colleagues, and stereotypes are used.</ul></li><ul><li>Multiple formal and informal complaints, which demonstrates unethical attributes, have been submitted about the Product/Service and/or Product team etiquette and the ineffective processes.</ul></li><ul><li>More time is spent planning than building the framework of the Product/Service without a complex feedback system, prioritized feedback or an understanding of the Product/Service's impact to all communities in the Province.</ul></li><ul><li>Product is outdated in all aspects prior to release.</ul></li>
...
3 | Acceptance | <ul><li>Feedback is collected actively, with congenial etiquette, with consent, and with actionable intent.</ul></li>
4 | Adaption | <ul><li>"The Grandmother Prespective": data collection comes from a fondation of empathy and the approach is decolonized and/or Indigenized, ensuring sensitivity and constant ethics visitation with the objective that data of vulnerable or disadvantaged communities are not weaponized against them.</ul></li><ul><li>Security reviews are conducted weekly to maintain momentum between modern risks and threats and modernized era of fortified civil rights acknowledgement.</ul></li><ul><li>Feedback system incorporates Equity Impact Assessments for all groups, empathy, confidentiality, and open-ended questions.</ul></li><ul><li>Data collection is based on genuine relationship building initiatives and all solutions and outcomes are trauma informed.</ul></li>

## 1.2 Collaboration
Tier | Mindset | Content
------------ | ------------- | -------------
0 | Denial | <ul><li>Product/Service decisions are centred top-down instead of collaboratively.</ul></li><ul><li>"What do they mean by that?": The product team have a common understanding of language and vocabulary and this is projected onto the Product/Service without considering user experience.</ul></li><ul><li>"Firefighting": Generational planning is compromised because priorities are changed without change management tactics.</ul></li>
